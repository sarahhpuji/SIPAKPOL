                            ...
                            <div class="col-md-12">
                                <table class="table table-dataTable table-striped" data-sort>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg2"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg3"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg4"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg5"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg6"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg7"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg8"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg9"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg10"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg15"><i class="fa fa-info"></i>
                                                    Lihat
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td> 16 </td>
                                            <td> Surat Pernyataan Melaksanakan Kegiatan Pendidikan </td>
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal-lg15"><i class="fa fa-info"></i>
                                                    Lihat
                                            ...
                                            <td>
                                                <div class="modal fade" id="modal-lg15">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Surat Pernyataan Melaksanakan
                                                                    Kegiatan Pendidikan
                                                                </h4>
                                                                <button type="button" class="close"
                                                                    data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($Berkaspengajuan->status == 2)
                                        <form
                                            action="{{ url('Admin/pengajuan/pengajuan-masuk/deskripsi', $Berkaspengajuan->id) }}"
                                            method="post">
                                            @csrf
                                            <div class="form-group">
                                                <label for="deskripsi" class="control-label">Catatan</label>
                                                <textarea name="deskripsi" id="deskripsi" class="form-control"></textarea>
                                            </div>
                                            <button class="btn btn-info btn-sm"><i class="fa fa-save"></i><b>
                                                    Simpan</b></button>
                                        </form>
                                    @endif
                                </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        @if ($Berkaspengajuan->status == 2)
                                            <div class="btn-group float-right">
                                                <form
                                                    action="{{ url('Admin/pengajuan/pengajuan-masuk/setuju', $Berkaspengajuan->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button class="btn btn-success"><i class="fa fa-check"></i> <b>
                                                            Disetujui</b></button>
                                                </form>
                                                <form
                                                    action="{{ url('Admin/pengajuan/pengajuan-masuk/ditolak', $Berkaspengajuan->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
