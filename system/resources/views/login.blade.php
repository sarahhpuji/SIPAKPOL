...
<body style="background-color: #e8edff;">
            ...
            <div class="wrap-login100">
                <form action="{{ url('login') }}" method="post" class="login100-form validate-form">
                    ...
                    @foreach (['success', 'danger', 'warning', 'info'] as $status)
                        ...
                        @endif
                    @endforeach
                    <div class="wrap-input100 validate-input" data-validate="Valid Nip/Nup is required: ex@abc.xyz">
                        <input class="input100" type="text" name="nip">
                        <span class="focus-input100"></span>
                        <span class="label-input100">NIP/NUP</span>
                    </div>
                ...
                <div class="login100-more" style="background-image: url('public/login/images/pakpol.jpg');">
                </div>
            </div>
        </div>
    </div>
